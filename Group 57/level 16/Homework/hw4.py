...
simarle = int(input("sheni simarle): "))
wona = int(input("sheni wona: "))

if simarle >= 180 and 50 <= wona <= 90:
    print("shegizlia shexvide zooparkshi")
else:
    print("ar shegizlia shexvide zooparkshi")